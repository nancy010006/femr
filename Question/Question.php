...
function addNewQuestion($alldata){
    global $conn;
...
function addSleepQuestion($alldata) {
        ...
        $sleep_at_hour     = mysqli_real_escape_string($conn,@$alldata['sleep_at_hour']);
        $sleep_at_minute   = mysqli_real_escape_string($conn,@$alldata['sleep_at_minute']);
        $awake_at_hour     = mysqli_real_escape_string($conn,@$alldata['awake_at_hour']);
        $awake_at_minute   = mysqli_real_escape_string($conn,@$alldata['awake_at_minute']);
        ...
        $sleep_at          = $sleep_at_hour . $sleep_at_minute;
        $awake_at          = $awake_at_hour . $awake_at_minute;
