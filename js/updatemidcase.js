...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success:function(r){
                    ...
                    if(result[0].status==200){
                        ...
                        $("#form2 input[name='name']").val(result[1]['name']);
                        $("#form2 input[name='birthday']").val(result[1]['birthday']);
                        $("#form2 input[name='date']").val(result[1]['date']);
    ...
    $('#form2').submit(function(event){
        ...
        // console.log(serializeform);
        var postdata= objectifyForm(serializeform,"addCaseHistory");
        if($("#other").prop('checked')){
            var key = 'datafrom';
            // 复制原来的值
            postdata[1][key] = postdata[1]['othercontent'];
