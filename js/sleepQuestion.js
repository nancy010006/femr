...
function makeTimeSelect(){
    for (var i = 24; i > 0; i--) {
        ...
        $('#sleep_at_hour').append('<option value="' + value + '">' + value + '</option>')
    }
    for (var i = 0; i < 60; i+=10) {
        var value = paddingLeft(i.toString(),2);
        $('#sleep_at_minute').append('<option value="' + value + '">' + value + '</option>')
    }
    ...
    for (var i = 0; i < 13; i++) {
        var value = paddingLeft(i.toString(),2);
        $('#awake_at_hour').append('<option value="' + value + '">' + value + '</option>')
    }
    for (var i = 0; i < 60; i+=10) {
        var value = paddingLeft(i.toString(),2);
        $('#awake_at_minute').append('<option value="' + value + '">' + value + '</option>')
    }
}
